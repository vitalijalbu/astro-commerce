...
export const homepageBrands = [
	{ name: 'Northline', logo: '/images/placeholder.png', href: '/brands' },
	{ name: 'Meridian', logo: '/images/placeholder.png', href: '/brands' },
	{ name: 'House of Oak', logo: '/images/placeholder.png', href: '/brands' },
	{ name: 'Studio Forma', logo: '/images/placeholder.png', href: '/brands' },
	{ name: 'Common Thread', logo: '/images/placeholder.png', href: '/brands' },
	{ name: 'Atelier Supply', logo: '/images/placeholder.png', href: '/brands' },
];
...
export const homepageSections: Section[] = [
	...
	},
	{
		...
		type: 'image-banner',
		settings: {
			image: 'https://picsum.photos/seed/promo-banner/2000/900',
			heading: 'The Outerwear Edit',
			subheading: 'Cold-weather staples',
			text: 'Considered coats and jackets, cut for everyday layering.',
			primaryCta: { label: 'Shop outerwear', href: '/collections/menswear' },
			secondaryCta: { label: 'Explore all', href: '/collections/all' },
			align: 'left',
			height: 'large',
		},
	},
	...
	},
	{
		...
		settings: {
			...
			tiles: [
				{
					image: 'https://picsum.photos/seed/tile1/900/1100',
					title: 'Outerwear',
					href: '/collections/menswear',
					size: 'large',
				},
				{
					image: 'https://picsum.photos/seed/tile2/700/500',
					title: 'Knitwear',
					href: '/collections/new-arrivals',
					size: 'small',
				},
				{
					image: 'https://picsum.photos/seed/tile3/700/500',
					title: 'Accessories',
	...
	},
	{
		...
		settings: {
			heading: 'On sale now',
			subheading: 'Selected styles at reduced prices — while stocks last.',
	...
	},
	{
		...
		settings: {
			...
			subheading: 'Accessories to complete the look.',
	...
	},
	{
		...
		settings: {
			...
			items: [
				{
					quote:
						'The quality is genuinely exceptional. My blazer gets compliments every time I wear it.',
					author: 'Elena R.',
					role: 'Verified buyer',
					rating: 5,
				},
				{
					quote:
						'Fast shipping, beautiful packaging, and the fit is perfect. Will absolutely order again.',
					author: 'Marco T.',
					role: 'Verified buyer',
					rating: 5,
				},
				{
					quote: 'Finally a brand that does timeless basics right. Everything works together.',
					author: 'Sofia L.',
					role: 'Verified buyer',
					rating: 5,
				},
			...
			items: [
				{
					...
					content:
						'Standard delivery is 2–4 working days. Express options are available at checkout.',
				},
				{
					title: 'What is your returns policy?',
					content:
						'Return anything within 30 days for a full refund — no questions asked. Items must be unworn with tags attached.',
				},
				{
					title: 'Do you ship internationally?',
					content:
						'Yes, we ship worldwide. Duties and taxes are calculated at checkout for most destinations.',
				},
				{
					title: 'How do I track my order?',
					content:
						"You'll receive a tracking link by email as soon as your order ships. You can also see status in your account.",
				},
			],
		},
	},
