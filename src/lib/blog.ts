...
const posts: BlogPost[] = [
    ...
    },
    {
        ...
        excerpt: 'Simple care routines that keep linen, wool and cotton looking premium season after season.',
        ...
        content: [
            ...
            },
            {
                ...
                bullets: [
                    ...
                    'Hardware and trim verification'
                ]
            },
            {
...
export const getBlogSummaries = (): BlogPostSummary[] =>
    getBlogPosts().map(toSummary)
